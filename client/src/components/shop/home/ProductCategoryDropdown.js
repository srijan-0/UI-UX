...
const CategoryList = () => {
  ...
  <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4`}>
    <hr />
    <div className="py-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
          ...
          return (
            <Fragment key={index}>
              <div
                ...
                className="col-span-1 m-2 flex flex-col items-center justify-center space-y-2 cursor-pointer transition-transform hover:scale-105"
              >
                <img
