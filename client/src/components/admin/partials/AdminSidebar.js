  ...
  return (
    <Fragment>
      ...
      >
        ...
        {/* New Notice Section */}
        <div
          onClick={(e) => history.push("/admin/dashboard/notices")}
          className={`${location.pathname === "/admin/dashboard/notices"
            ? "border-r-4 border-gray-800 bg-gray-100"
            : ""
            } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          <span>
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 8v4m0 0l2-2m-2 2l-2-2m0 0H6m6 4v4m0 0l2-2m-2 2l-2-2"
              />
            </svg>
          </span>
          <span className="hover:text-gray-800">Notices</span>
        </div>
        <hr className="border-b border-gray-200" />
        {/* Appointments Section */}
<div
  onClick={(e) => history.push("/admin/dashboard/appointments")}
  className={`${location.pathname === "/admin/dashboard/appointments"
    ? "border-r-4 border-gray-800 bg-gray-100"
    : ""
    } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
>
  ...
  <span className="hover:text-gray-800">Appointments</span>
</div>
<hr className="border-b border-gray-200" />
